...
CoffeeScript = require('coffee-script/lib/coffee-script/coffee-script.js');
...
verify = function(ruleset) {
  ...
  test_position = function(pos, dir, spr) {
    var arr, from, i, len, line, mask, to, _i, _ref, _results;
    arr = [];
...
for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  part = _ref[_i];
  fileContent = fs.readFileSync(part + '_schema', 'utf8');
